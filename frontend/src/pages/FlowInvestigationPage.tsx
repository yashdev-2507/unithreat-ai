    ...
    <div className="space-y-6">
      ...
      <PageHeader
        ...
        actions={
          <Link
            to="/flows"
            className="inline-flex items-center gap-1.5 rounded-md border border-[#E5E5E5] bg-[#FFFFFF] px-3 py-1.5 text-xs font-mono text-slate-700 hover:bg-[#F5F5F5] hover:text-[#0A0A0A] focus-ring"
          >
      ...
      <DataStateWrapper state={dataState} onRetry={fetchFlowData}>
        {flow ? (
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-[#E5E5E5] bg-[#FFFFFF] p-5 space-y-4 shadow-2xs">
              <div className="flex items-center justify-between border-b border-[#E5E5E5] pb-3">
                <h3 className="text-sm font-bold text-[#0A0A0A] uppercase tracking-wider font-mono flex items-center gap-2">
              ...
              {relatedAlerts.length === 0 ? (
                ...
                <div className="overflow-x-auto focus-ring rounded-lg border border-[#E5E5E5]" role="region" aria-label="Related Threat Alerts Dataset" tabIndex={0}>
                        ...
                        >
                          ...
                          <td className="py-2.5 px-3 text-right whitespace-nowrap">
                            <button
                              ...
                              className="inline-flex items-center gap-1 rounded border border-[#E5E5E5] bg-[#FFFFFF] px-2 py-1 text-[11px] text-[#0A0A0A] hover:bg-[#F5F5F5] focus-ring font-mono"
          ...
          <div className="rounded-xl border border-[#E5E5E5] bg-[#FFFFFF] p-8 text-center shadow-2xs">
            <h3 className="text-base font-bold text-[#0A0A0A] font-sans">
              Passive Flow Record Not Found
            </h3>
            <p className="mt-1 text-xs text-[#525252] font-sans max-w-md mx-auto">
              No passive flow record matching ID <code className="text-[#2563EB]">{flowId}</code> was found in the DataService.
            </p>
            <div className="mt-4">
              <Link
                to="/flows"
                className="inline-flex items-center gap-1.5 rounded-md border border-[#2563EB] bg-[#2563EB] px-3 py-1.5 text-xs font-bold text-white hover:bg-[#1D4ED8] focus-ring font-mono"
              >
